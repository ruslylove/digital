...
\begin{circuitikz}[american, scale=1.0]
    ...
    \node[flipflop D, flipflop def={nd=1}] (DFF_A) at (8, 2) {};
    \node[above] at (DFF_A.n) {Flip-Flop A};
    \node[flipflop D, flipflop def={nd=1}] (DFF_B) at (8, -2.5) {};
    ...
    \path (DFF_A.pin 6) -- ++(2.5, 0) coordinate (y_pos);
    ...
    % x to AND_y
    % Route x all the way
    \draw (x_bus_top) -- ++(0, -7.1) coordinate (x_bus_bot) -- ++(12, 0) coordinate (x_far_right) |- (AND_y.in 2);
   ...
   % \draw [fill=white] (DFF_B.s) circle(2pt);
    ...
    \draw (rst_in) -| (DFF_B.down);

    % Route to A
    \draw (DFF_A.down) -- ++(0, -0.5) -- ++(-1.2,0) coordinate (rst_out);
